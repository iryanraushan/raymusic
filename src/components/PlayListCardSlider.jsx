...
const PlayListCardSlider = ({ title, id, image }) => {
  return (
    <Link
      to={`/playlists/${id}`}
    ...
    >
      ...
      <div className="text-[14px] font-semibold flex w-full flex-col justify-center items-center px-5 mt-3  mb-5">
        <span className="text-[#e6e6e6] text-[16px] text-center w-[100%] font-semibold whitespace-nowrap overflow-hidden overflow-ellipsis">
...
export default PlayListCardSlider;
